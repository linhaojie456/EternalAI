    ...
    Column(modifier = Modifier.fillMaxSize().background(NeoChineseColors.InkBlack)) {
        Row(modifier = Modifier.padding(8.dp)) {
            OutlinedTextField(
                ...
                placeholder = { Text("搜索对话...", color = NeoChineseColors.Gray) },
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(containerColor = NeoChineseColors.Gold)
            ) {
                    ...
                    Row(Modifier.padding(8.dp)) {
                        Column(Modifier.weight(1f)) {
                            Text(
                                ...
                                color = NeoChineseColors.RicePaper,
                                fontSize = 14.sp
                            )
                        }
                        Button(
                            ...
                            colors = ButtonDefaults.buttonColors(containerColor = NeoChineseColors.Cinnabar)
                        ) {
